...
class ScheduleGenerationController extends GetxController {
  ...
  void toggleServiceSelection(ServiceHive service) {
    ...
    try {
      ...
      for (final service in selectedServices) {
        generationStatus.value =
            'Génération pour ${service.nom} (${processedServices + 1}/${selectedServices.length})';
        ...
        processedServices++;
        generationStatus.value =
            'Terminé: ${service.nom} ($processedServices/${selectedServices.length})';
